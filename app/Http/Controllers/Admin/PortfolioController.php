...
class PortfolioController extends Controller
{
    ...
    {
        $items = Portfolio::with(['subcategory'])
    ...
    public function create()
    {
        ...
        return view('pages.admin.portfolio.create', ['categories' => $categories, 'subcategories' => $subcategories ]);
    }
    ...
    public function store(PortfolioRequest $request)
    {
        ...
        if($request->hasFile('images')) {
         ...
         return redirect('admin/portfolio/category/' . $category )->withSuccess('Portfolio created!');
    }
    ...
    public function update(Request $request, Portfolio $portfolio)
    {
        ...
        $item->update($data); 
        return redirect('admin/portfolio/category/' . $request->category_id)->withSuccess('Portfolio updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        $gallery->delete();
        $portfolio->delete();
        return redirect('admin/portfolio/category/' . $category)->withDanger('Portfolio removed!');;
    }
