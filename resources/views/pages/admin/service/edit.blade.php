                                ...
                                <form action="{{route('service.update', $service->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="summary" 
                                                rows="3" placeholder="" value="{{ old('summary') }}" class="form-control">{{$service->summary}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <textarea name="content" id="summernote" placeholder="" value="{{ old('content') }}" class="form-control">{{$service->content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="link" value="{{ $service->link }}" class="form-control @error('link') is-invalid @enderror">
                                            @error('link')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="price" value="{{$service->price}}"  class="form-control @error('price') is-invalid @enderror">
                                            @error('price')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                   ...
                                   <div class="row form-group">
                                        ...
                                        <div class="col-sm-3"> 
                                            <img src="{{Storage::url($service->image)}}" class="img-thumbnail">
                                        </div>
                                        <div class="col-12 col-md-9">
