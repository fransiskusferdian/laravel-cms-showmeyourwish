                    ...
                    @foreach ($items as $item)
                        <div class="card mr-2" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="" data-href="{{route('service.destroy', $item->id)}}" class="btn btn-danger" data-toggle="modal"
                                    data-target="#deleteServiceModal"><i class="fa fa-trash"></i>
                                </a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="" method="post" id="deleteservice">
                                ...
                                <div class="modal-body">Are you sure want to delete this Service?</div>
...
@push('after-script')
      <script>
        $('#deleteServiceModal').on('show.bs.modal', function (e) {
            $(this).find('#deleteservice').attr('action', $(e.relatedTarget).data('href'));
        });
      </script>
@endpush