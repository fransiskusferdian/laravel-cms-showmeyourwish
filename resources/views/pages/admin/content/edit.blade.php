                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{route('content.update', $content->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="summary" 
                                                rows="3" placeholder="" value="{{ old('summary') }}" class="form-control">{{$content->summary}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <textarea name="content" id="summernote" placeholder="" value="{{ old('content') }}" class="form-control">{{$content->content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="link" value="{{ $content->link }}" class="form-control @error('link') is-invalid @enderror">
                                            @error('link')
                                            <div class="invalid-feedback">{{$message}}</div>
                                            @enderror
                                        </div>
                                   ...
                                   <div class="row form-group">
                                        ...
                                        <div class="col-sm-3"> 
                                            <img src="{{Storage::url($content->image)}}" class="img-thumbnail">
                                        </div>
                                        <div class="col-12 col-md-9">
