...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?= base_url('assets/client-side/'); ?>css/all.min.css">

    <!-- Google Font -->
    <link href="https://fonts.googleapis.com/css?family=Lora:400,700|Montserrat:200,400,600&display=swap" rel="stylesheet">

    <!-- Owl Carousel -->
    <link rel="stylesheet" href="<?= base_url('assets/client-side/'); ?>css/owl.carousel.css">
...
<script>
  ...
  gtag('config', 'UA-157936492-1');
    ...
    <title>Show Me Your Wish | Journal</title>
</head>

<body data-spy="scroll" data-target=".navbar" data-offset="47">
    <!-- Navbar -->
 <header id="header" class="headroom header--fixed">      
    <nav class="navbar navbar-expand-lg nav-down bg-light navbar-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" active href="<?= base_url('journal') ?>">Journal</a>
                    </li>
                </ul>
            </div>
        </div>
