                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-id-badge"></i><a href="{{ url('admin/portfolio/category/1') }}">Photograph</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url('admin/portfolio/category/2') }}">Videograph</a></li>
